...
class HomeController extends GetxController with GetTickerProviderStateMixin {
  ...
  categoriesListApi() async {
    try {
      CategoryModel categoryModel = await ApiProvider.shopify().funCategoriesApi();

      print('categoryModel Data');
      print(categoryModel.customCollections!.length);
      if(categoryModel.customCollections!.isNotEmpty){
        categories.value = categoryModel.customCollections!;
